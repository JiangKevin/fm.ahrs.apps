...
RaycastVehicleDemo::RaycastVehicleDemo( Context* context ) : BaseApp( context )
{
...
void RaycastVehicleDemo::HandleUpdate( StringHash eventType, VariantMap& eventData )
{
    ...
    if ( vehicle_ )
    {
        ...
        if ( ! ui->GetFocusElement() )
        {
            ...
            {
                File saveFile( context_, GetSubsystem< FileSystem >()->GetProgramDir() + "Data/Scenes/RaycastVehicleDemo.xml", FILE_WRITE );
